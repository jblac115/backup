...
let questions=[
    ...
    {
        title:'what team won the super bowl this year?',
        alternatives: ['Eagles', 'niners', 'Chargers ','Kansas city Chiefs'],
        correctAnswer: 0
    }
]
let app={
    ...
    showResults:function(isCorrect){
        ...
        if(isCorrect){
            ...
            result="wrong answer "+correctText;
        }
...
//     alts.forEach(function(element,index){
//         element.addEventListener('click',function(){
//           console.log('check the right answer')
//         })
//     })
